...
local VyrenHubConfig = Window.ConfigManager:CreateConfig("Vyrenhub")
...
local function Reg(id, element)
    VyrenHubConfig:Register(id, element)
...
local BaseFolder = "WindUI/" .. (Window.Folder or "VyrenHub") .. "/config/"
...
local ShopItems = {
    ["Rods"] = {
    {Name = "Luck Rod", ID = 79, Price = 325}, {Name = "Carbon Rod", ID = 76, Price = 750}, {Name = "Grass Rod", ID = 85, Price = 1500}, {Name = "Demascus Rod", ID = 77, Price = 3000}, {Name = "Ice Rod", ID = 78, Price = 5000}, {Name = "Lucky Rod", ID = 4, Price = 15000}, {Name = "Midnight Rod", ID = 80, Price = 50000}, {Name = "Steampunk Rod", ID = 6, Price = 215000}, {Name = "Chrome Rod", ID = 7, Price = 437000}, {Name = "Flourescent Rod", ID = 255, Price = 715000}, {Name = "Astral Rod", ID = 5, Price = 1000000}, {Name = "Ares Rod", ID = 126, Price = 3000000}, {Name = "Angler Rod", ID = 168, Price = 8000000}, {Name = "Bamboo Rod", ID = 258, Price = 12000000}
    },
    ["Bobbers"] = {
    {Name = "Floral Bait", ID = 20, Price = 4000000}, {Name = "Aether Bait", ID = 16, Price = 3700000}, {Name = "Corrupt Bait", ID = 15, Price = 1148484}, {Name = "Dark Matter Bait", ID = 8, Price = 630000}, {Name = "Chroma Bait", ID = 6, Price = 290000}, {Name = "Nature Bait", ID = 17, Price = 83500}, {Name = "Midnight Bait", ID = 3, Price = 3000}, {Name = "Luck Bait", ID = 2, Price = 1000}, {Name = "Topwater Bait", ID = 10, Price = 100},
    },
    ["Boats"] = {
    {Name = "Mini Yach", ID = 14, Price = 1200000}, {Name = "Fish Boat", ID = 6, Price = 180000}, {Name = "Speed Boat", ID = 5, Price = 70000}, {Name = "Highfield Boat", ID = 4, Price = 25000}, {Name = "Jetski", ID = 3, Price = 7500}, {Name = "Kayak", ID = 2, Price = 1100}, {Name = "Small Boat", ID = 1, Price = 100},
    },
}
...
do
    ...
    _G.VyrenHub_AutoAcceptTradeEnabled = false 
    ...
    if PromptController and PromptController.FirePrompt and Promise then
        ...
        PromptController.FirePrompt = function(self, promptText, ...)
            ...
            if _G.VyrenHub_AutoAcceptTradeEnabled and type(promptText) == "string" and promptText:find("Accept") and promptText:find("from:") then
        ...
        warn("[VyrenHub] Gagal memuat PromptController/Promise untuk Auto Accept Trade.")
    end
end
...
do
    ...
    home:Section({
        Title = "Join Discord Server VyrenHub",
        TextSize = 18,
    })

    home:Paragraph({
        Title = "VyrenHub Community",
        ...
        Buttons = {
            {
                ...
                Icon = "link",
                Callback = function()
                    setclipboard("https://dsc.gg/MGrd35QPX")
                    WindUI:Notify({
                        Title = "Link Disalin!",
                        Content = "Link Discord VyrenHub berhasil disalin.",
                        Duration = 3,
                        Icon = "copy",
                    })
                end,
    ...
    home:Paragraph({
        Title = "Version 0.0.1",
        Desc = "- 30 Des 2025, I Want Release Freemium & Premium Fiture",
    })
    home:Paragraph({
        Title = "Beta Update",
        Desc = "[+] Add Auto Fishing = Legit,Instant,Blatant 3 Settings\n[+] Add Fishing Area\n[+] Add Auto Sell\n[+] Add Auto Favorite & Unfav\n[+] Add Auto Artifact\n[+] Add Auto Event\n[+] Add Auto Trade\n[+] Add Auto Enchant\n[+] Add Auto Second Enchant\n[+] Add Teleport Fishing & Event\n[+] Add Shop\n[+] Add Quest\n[+] Add Event Lochness\n[+] Add Webhook\n\nI will work on small updates soon... ",
    })
end
        ...
        if data then
            ...
            if targetPlayer.Character then
                for _, v in ipairs(targetPlayer.Character:GetChildren()) do
                    if v.Name == "VyrenHubESP" and v:IsA("BillboardGui") then pcall(function() v:Destroy() end) end
                end
            end
        end
    end
...
do
    ...
    local function disableOtherModes(currentMode)
        pcall(function()
            ...
            local toggleBlatant = farm:GetElementByTitle("Blatant Fishing")
    ...
    _G.VyrenHub_BlatantActive = false
    ...
    task.spawn(function()
        ...
        if S1 and FishingController then
            ...
            FishingController.RequestChargeFishingRod = function(...)
                if _G.VyrenHub_BlatantActive then return end 
                return Old_Charge(...)
            end
            FishingController.SendFishingRequestToServer = function(...)
                if _G.VyrenHub_BlatantActive then return false, "Blocked by VyrenHub" end
                return Old_Cast(...)
            end
        end
    end)
    ...
    mt.__namecall = newcclosure(function(self, ...)
        ...
        if _G.VyrenHub_BlatantActive and not checkcaller() then
    ...
    local function SuppressGameVisuals(active)
        ...
        if active then
            task.spawn(function()
                ...
                while _G.VyrenHub_BlatantActive do
    ...
    local LoopIntervalInput = Reg("blatantint", blatant:Input({
        Title = "Blatant Interval(Loop)", Value = tostring(loopInterval), Icon = "fast-forward", Type = "Input", Placeholder = "1.58",
    ...
    local togblat = Reg("blatantt",blatant:Toggle({
        ...
        Callback = function(state)
            ...
            _G.VyrenHub_BlatantActive = state
...
local function GetItemsToFavorite()
    ...
    local accept = trade:Toggle({
        ...
        Value = false,
        Callback = function(state)
            _G.VyrenHub_AutoAcceptTradeEnabled = state
...
do
    ...
    local function CreateKaitunUI()
        local old = game.CoreGui:FindFirstChild("VyrenHubKaitunStats")
        if old then old:Destroy() end
        local sg = Instance.new("ScreenGui")
        sg.Name = "VyrenHubKaitunStats"
        ...
        txt("KAITUN VyrenHub (PREMIUM)", 0.2, Color3.fromRGB(255,0,255), 35)
    ...
    local function RunDiscoLoop()
        ...
        DISCO_EQUIP_THREAD = task.spawn(function()
            while DISCO_UNLOCK_STATE do
                ...
                task.wait(0.5) -- Spam equip agar selalu pegang rod
            end
        end)
        ...
        Callback = function(state)
            ...
            if state then
                ...
                if not _G.BlackScreenGUI then
                    ...
                    _G.BlackScreenGUI.Name = "VyrenHub_BlackBackground"
        ...
        Callback = function(state)
            ...
            if state then
                ...
                for _, gui in ipairs(PlayerGui:GetChildren()) do
                    if gui:IsA("ScreenGui") and gui.Name ~= "WindUI" and gui.Name ~= "CustomFloatingIcon_VyrenHub" then
...
do
    ...
    local WEBHOOK_URL = ""
    local WEBHOOK_USERNAME = "VyrenHub Notify" 
    ...
    local GLOBAL_WEBHOOK_USERNAME = "VyrenHub | Community"
    ...
    local function onFishObtained(itemId, metadata, fullData)
        local success, results = pcall(function()
            ...
            if isWebhookEnabled and WEBHOOK_URL ~= "" and isUserFilterMatch then
                local title_private = string.format("<:TEXTURENOBG:1438662703722790992> VyrenHub | Webhook\n\n<a:ChipiChapa:1438661193857503304> New Fish Caught! (%s)", fishName)
                ...
                local embed = {
                    ...
                    footer = {
                        text = string.format("VyrenHub Webhook • Total Caught: %s • %s", caughtDisplay, os.date("%Y-%m-%d %H:%M:%S"))
                    }
                }
            ...
            if isGlobalTarget and GLOBAL_WEBHOOK_URL ~= "" then 
                ...
                local title_global = string.format("<:TEXTURENOBG:1438662703722790992> VyrenHub | Global Tracker\n\n<a:globe:1438758633151266818> GLOBAL CATCH! %s", fishName)
                ...
                local globalEmbed = {
                    ...
                    thumbnail = { url = imageUrl },
                    footer = {
                        text = string.format("VyrenHub Community| Player: %s | %s", censoredPlayerName, os.date("%Y-%m-%d %H:%M:%S"))
                    }
                }
        ...
        if not success then
            warn("[VyrenHub Webhook] Error processing fish data:", results)
        end
    end
...
do
    ...
    local SelectedConfigName = "VyrenHub" -- Default
    local BaseFolder = "WindUI/" .. (Window.Folder or "VyrenHub") .. "/config/"
    ...
    ConfigSection:Button({
        ...
        Callback = function()
            ...
            -- 1. Save ke config utama dulu ("VyrenHub.json")
            VyrenHubConfig:Save()
            task.wait(0.1)

            -- 2. Jika nama beda, salin isi "VyrenHub.json" ke "NamaBaru.json"
            if SelectedConfigName ~= "VyrenHub" then
                local success, err = pcall(function()
                    local mainContent = readfile(BaseFolder .. "VyrenHub.json")
    ...
    ConfigSection:Button({
        ...
        Callback = function()
            if SelectedConfigName == "" or SelectedConfigName == "VyrenHub" then 
            ...
            if isfile(path) then
                ...
                RefreshConfigList(ConfigDropdown)
                ConfigNameInput:Set("VyrenHub")
                SelectedConfigName = "VyrenHub"
            else
    ...
    --ConfigSection:Paragraph({
       ...
       -- Desc = "Script otomatis menyimpan ke 'VyrenHub.json' setiap 30 detik.",
      --  Icon = "info"
 --   })
end
...
WindUI:Notify({ Title = "VyrenHub Was Loaded", Content = "Press [F] to open/close the menu", Duration = 5, Icon = "info" })
-- [[ AUTO LOAD & SAVE LOOP ]]
task.spawn(function()
    task.wait(2) -- Tunggu UI load sempurna
    
    -- Ganti Load biasa dengan Smart Load
    -- Default load "VyrenHub", atau nama config terakhir user kalau kamu simpan
    SmartLoadConfig("VyrenHub") 
    
    -- Auto Save Loop (Setiap 30 detik) -- Save tetap pakai cara biasa gapapa
    while true do
         task.wait(10)
         pcall(function() VyrenHubConfig:Save() end)
    end
end)
InitializeIcon()